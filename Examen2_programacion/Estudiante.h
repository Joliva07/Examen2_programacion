...
public: 
	...
	Estudiante(int ides,string car,string nom, string ape, string dir,int tel, int gen, string em, string fn) {
		idEstud = ides;
		carnet = car;
		nombres = nom;
		apellidos = ape;
	...
	void insertar() {
		...
		if (cn.getConectar()) {
			string insertar = "insert into estudiantes(carnet,nombres,apellidos,direccion,telefono,genero,email,fecha_nacimiento) values('" + carnet + "','" + nombres + "','" + apellidos + "','" + direccion + "'," + t + "," + g + ",'" + email + "','" + fecha_n + "');";
	...
	void actualizar() {
		...
		if (cn.getConectar()) {
			...
			string update = "update estudiantes set carnet='"+carnet+"',nombres='"+nombres+"',apellidos='"+apellidos+"',direccion='"+direccion+"',telefono="+t+",genero="+g+",email='"+email+"',fecha_nacimiento='"+fecha_n+"' where id_estudiante=" + p + ";";
